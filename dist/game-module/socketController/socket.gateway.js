...
let AppGateway = class AppGateway {
    constructor(authService, questionRepository) {
        this.authService = authService;
        this.questionRepository = questionRepository;
        this.rooms = new Map();
        this.userRooms = new Map();
        this.roomsSet = new Set();
        this.userAnswers = new Map();
        this.userQuestionIndex = new Map();
    }
    async handleConnection(socket) {
        console.log(...oo_oo(`1163538714_43_4_43_69_4`, 'AppGateway ~ handleConnection ~ socket:', socket.id));
        const token = socket.handshake.headers.authorization;
        console.log(...oo_oo(`1163538714_45_4_45_64_4`, 'AppGateway ~ handleConnection ~ token:', token));
    ...
    async handleDisconnect(socket) {
        console.log(...oo_oo(`1163538714_55_4_55_69_4`, 'AppGateway ~ handleDisconnect ~ socket:', socket.id));
        const token = socket.handshake.headers.authorization;
        const user = await this.authService.validateUser(token);
        if (user) {
    ...
    addUserToRoomId(roomId, userId) {
        ...
        console.log(...oo_oo(`1163538714_73_4_73_41_4`, `roooms Map`, this.rooms));
        return;
    }
    addRoomToUserId(roomId, userId) {
        ...
        console.log(...oo_oo(`1163538714_83_4_83_49_4`, `user Rooms map`, this.userRooms));
        return;
    }
    getAvailableRooms() {
    ...
    async handleMessage(body, socket) {
        const token = socket.handshake.headers.authorization;
        const user = await this.authService.validateUser(token);
        if (!user) {
            socket.disconnect(true);
    ...
    async sendQuestion(socket) { }
    async submitAnswer(body, socket) {
        const token = socket.handshake.headers.authorization;
        const user = await this.authService.validateUser(token);
        if (!user) {
            socket.disconnect(true);
        ...
        console.log(...oo_oo(`1163538714_153_4_153_75_4`, `score data ---->`, this.userAnswers.get(`${user.userId}`)));
        const nextQuestion = await this.questionRepository.getQuestions(body.nextPage, body.pageSize);
        ...
        if (!nextQuestion.length) {
            ...
            this.server
                .to(`${roomId}`)
                .emit('game:end', `Winner is ${user.email}, score: ${this.userAnswers.get(`${user.userId}`)}`);
    ...
    async handleLeaveRoom(data, socket) {
        ...
        console.log(...oo_oo(`1163538714_195_4_195_58_4`, `Client ${socket.id} left room ${roomId}`));
    }
    async saveUserScoreData(userIds, roomId) {
        if (!userIds.length) {
            return;
        }
        userIds.forEach((ele) => {
            this.questionRepository.saveGameScore(ele, roomId, this.userAnswers.get(`${ele}`));
...
__decorate([
    (0, websockets_1.SubscribeMessage)(`game:init`),
...
__decorate([
    (0, websockets_1.SubscribeMessage)(`question:send`),
    __param(0, (0, websockets_1.ConnectedSocket)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket]),
    __metadata("design:returntype", Promise)
], AppGateway.prototype, "sendQuestion", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, socket_io_1.Socket]),
    __metadata("design:returntype", Promise)
], AppGateway.prototype, "submitAnswer", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('game:end'),
    __param(0, (0, websockets_1.ConnectedSocket)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket]),
    __metadata("design:returntype", Promise)
], AppGateway.prototype, "gameEnd", null);
__decorate([
