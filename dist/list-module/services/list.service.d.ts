...
export declare class ListService {
    ...
    saveUserList(contentId: string, userId: string, contentType: string): Promise<import("mongoose").Document<unknown, {}, import("../../model/list.model").ListInterface> & import("../../model/list.model").ListInterface & {
